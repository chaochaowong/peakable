...
The `read_macs2_narrow()` and `read_macs2_broad()` functions are the wrapper functions to `rtracklayers::import.bed()`, facilitating the import of MACS2 narrow and broad peak files in the BED6+4 format. The imported intervals are formatted as `GRanges` instances.
